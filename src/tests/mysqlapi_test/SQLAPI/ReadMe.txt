****************************************************************
               Welcome to SQLAPI++ Library 5.0.0
****************************************************************
...
-- MySQL: Prevent buffer allocation for LONG/LOB data when procedure parameters descibed (thanks Johannes Lipp).
...
-- Informix: Do not use ODBC64 by default for 64-bit platforms but use SA_INFROMIX_ODBC64 build option.
