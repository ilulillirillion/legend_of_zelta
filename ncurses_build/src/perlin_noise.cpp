...
PerlinNoise::PerlinNoise() {
  ...
  // Initialize the permutation vector of the reference values
  permutations = { 
  ...
  permutations.insert(
      permutations.end(), permutations.begin(), permutations.end()
  );
}


// Generate a new permutation vector based on the value of a seed
